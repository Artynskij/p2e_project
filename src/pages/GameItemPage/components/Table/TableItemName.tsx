...
export const TableItemName = ({ items, name, enName, setNewFilter, className, filters }: TableItemNameProps) => {
    ...
    return (
      <div className={`${styles.tableItemName} ${className}`}>
        <div className={styles.name}>
          <div
            ...
            <svg
              ...
              <path
                d="M4.47171 6.43917L0.22038 2.05066C-0.07346 1.74734 -0.07346 1.25686 0.22038 0.95676L0.92685 0.22749C1.22069 -0.07583 1.69584 -0.07583 1.98656 0.22749L5 3.33817L8.0134 0.22749C8.3073 -0.07583 8.7824 -0.07583 9.0731 0.22749L9.7796 0.95676C10.0735 1.26008 10.0735 1.75056 9.7796 2.05066L5.52829 6.43917C5.2407 6.7425 4.76555 6.7425 4.47171 6.43917Z"
                fill="white"
              />
            </svg>
          </div>
          {filters[enName] && (
            <span onClick={handleDeleteFilter} className={styles.deleteFilter}>
              +
            </span>
          )}
        </div>
        {show && (
          <div
            ...
            <div
              className={`${styles.tableItemListItem} ${
                !filters[enName] ? styles.tableItemListItem_active : ""
              }`}
